...
In \Cref{fig:error_decay_KH} we show that the solution to the skew-symmetric reduced models are stable and the accuracy in the approximation of the high fidelity solution increases with the dimension of the set of basis functions considered. From \Cref{fig:snap_solution_KH}, where snapshots of the high fidelity and reduced solutions at different time steps are shown, we notice that even in the case considered,  the reduced solution is not easily distinguis
\begin{figure}
\centering
