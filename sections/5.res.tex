...
Consider the 2D case of the compressible Euler equations \eqref{eq:3.18} ... .
In this test case we consider the flows of different layers of an heterogenous fluid in relative horizontal motion. If the heterogeneity considered consists in a stratification of different density layers, the fluid develops, at the interface between two separated layers, an hydrodynamic instability called Kelvin-Helmholtz instability \cite{HHS}. As a result of  the different tangential velocities,  Given the considered geometrical setting and the absence of external forces, this phenomenon is induced only by the initial condition. In our test cases we consider three different layers, 
\begin{equation*}
dasdasd
\end{equation*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
