...
\edit{Since the reduced system shows the same structure of \eqref{eq:3.27},  the same numerical integrator is used to compute the reduced solution, without decoupling the modes related to velocity, density and pressure.}